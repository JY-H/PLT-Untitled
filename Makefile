...
codegen.cmo : ast.cmo
codegen.cmx : ast.cmx
decaf.cmo : semant.cmo scanner.cmo parser.cmi codegen.cmo ast.cmo
decaf.cmx : semant.cmx scanner.cmx parser.cmx codegen.cmx ast.cmx
...
TARFILES = ast.ml codegen.ml Makefile decaf.ml parser.mly README scanner.mll \
